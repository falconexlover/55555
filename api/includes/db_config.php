...
$db_name = 'lesnoy_dvorik'; // Замените на имя базы данных, обычно начинается с вашего логина на Beget
$db_user = 'lesnoy_user'; // Замените на пользователя БД (обычно также начинается с логина на Beget)
$db_pass = 'password'; // Замените на пароль от базы данных
